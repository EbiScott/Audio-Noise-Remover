FROM python:3.11-slim          # Base Linux image with Python
...
WORKDIR /app                   # All your bot files live here
...
COPY . .                       # Copy bot.py, audio_processor.py etc.

CMD ["python", "bot.py"]       # Command Render runs to start your bot
```